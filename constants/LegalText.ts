...
## 1. Introduction
Welcome to VibeSwipe ("we," "our," or "us"). We are committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclosure, and safeguard your information when you use our mobile application (the "App").

## 2. Information We Collect
We collect information that you strictly provide to us:
- **Personal Data:** Name, email address, mood data, and journal entries.
- **Usage Data:** Anonymous interaction data with the app features.

## 3. How We Use Your Information
We use the information we collect to:
- Provide and maintain the App.
- Create your account and manage your profile.
- Analyze usage patterns to improve user experience (Anonymously).
...
This End-User License Agreement ("Agreement") is a legal agreement between you ("User") and VibeSwipe regarding your use of the VibeSwipe mobile application.

## 1. License Grant
VibeSwipe grants you a revocable, non-exclusive, non-transferable, limited license to download, install, and use the Application strictly in accordance with the terms of this Agreement.
...
2.  **Right to Rectification:** You have the right to request that we correct any information you believe is inaccurate.
3.  **Right to Erasure:** You have the right to request that we erase your personal data ("Right to be Forgotten").
4.  **Right to Restrict Processing:** You have the right to request that we restrict the processing of your personal data.
5.  **Right to Object to Processing:** You have the right to object to our processing of your personal data.
